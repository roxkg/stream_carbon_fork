...
# interposer_areas=[(interspace * 3 + 5.06*2)*(interspace * 4 + 5.06*3) for interspace in interspaces]
...
times = [0.875,1,1.2,1.4,1.6,1.8, 2]
...
# subprocess.run(["python", "main_stream_ga.py", "--interposer_area", str(interposer_area),"--is_chiplet"], check=True)
...
# for recycle_ratio in recycle_ratios:
    ...
    # subprocess.run(["python", "main_stream_ga.py",  "--interposer_area", str(interposer_area),"--rcy_mat_frac", str(recycle_ratio),"--is_chiplet"], check=True)
# x = 54644
