...
class CarbonFactory: 
    ...
    def create(self) -> CarbonParam: 
        ...
        carbon_intensity_data = open_yaml("stream/inputs/examples/carbon/carbon_intensity.yaml")
        ...
        return CarbonParam(CI_em= CI_em, CI_op= CI_op, lifetime= self.data["lifetime"])
